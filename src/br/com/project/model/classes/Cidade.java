...
public class Cidade implements Serializable {
	...
	@Basic // atributo básico
	@ManyToOne // Muitas cidades para um estado
	@JoinColumn(name = "estado", nullable = false) // junção de tabelas cidade e estado
	@ForeignKey(name = "estado_fk") // chave estrangeira de estado
	private Estado estado = new Estado();// aqui ta instanciando um novo objeto estado
